...
<main id="main">
    ...
    <div><h1 id="title">Dr. Norman Borlaug</h1>
        <p id="p1">The man who saved a billion lives</p>
    </div>
    <figure id="img-div">
    ...
    <ul>
        ...
        <li><b>19342</b> - Receives a Ph.D. in Genetics and Plant Pathology
        </li>
    ...
    <p id="p2"><cite>"Borlaug's life and achievement are testimony to the far-reaching contribution that one man's
        towering intellect, persistence and scientific vision can make to human peace and progress."</cite>
    </p>
    <p id="cite1">
        <cite>-- Indian Prime Minister Manmohan Singh</cite></p>

    <h3 id="tribute-info">If you have time, you should read more about this incredible human being on his <a
        id="tribute-link" href="https://en.wikipedia.org/wiki/Norman_Borlaug" target="_blank">Wikipedia entry.</h3>
